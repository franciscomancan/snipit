...
public class DocumentList<S extends SnippetDocument> implements ObservableList {

    private CopyOnWriteArrayList<S> docs;

    public DocumentList() {
        docs = new CopyOnWriteArrayList<>();
    }
    ...
    public boolean addAll(Object[] elements) {
        return Collections.addAll(docs, (S[]) elements);
    }
    ...
    public Object get(int index) {    	
        return docs.isEmpty()? null: docs.get(index);
    }
